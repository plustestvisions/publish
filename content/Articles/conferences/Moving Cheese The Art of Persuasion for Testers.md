...
# Learnings
3 ideas
1. people want help with their problems
2. we often share the same problems
3. solve problems without permission

It's easier to help someone, than persuade them to help you.

Structured approach: The 3 P's
1. Personality
	1. your style, how do you present your ideas trying to persuade others?
2. People
	1. your target, ***what is their problem***, how can you help them? Or how can help them
3. Plan
	1. your approach: do you have a deliberate plan? How will you show it is our problem?

Personality
How we act
How we are seen:
*Credibility:*
- coercive->forcing people only achieves compliance
- reward->thank you is a reward will achieve compliance only
- Legitimate->your position, inspiration, but lose your position is loose your power
- Expert-> skill, independent of position, be trusted
- Referent-> you are liked, so they are more willing to help you
- Informational->access to knowledge others do not have

Reasons people resist persuasion:
1. fear
2. loss of control
3. comfort (good enough)
4. personal (they do not like you)

How to respond to these:
1. what is causing this fear, can I solve it?
2. provide a choice, do not dictate
3. proof of concept, remove the physiological barrier
4. persuade someone else, and try to learn why they do not like you

Four steps to getting things done without permission
1. Talk about your idea
	1. ask questions about the idea with others, identify promoters and supporters
2. Create a proof of concept
	1. small POC that proves the idea and help others understand it
3. Show case work to everyone
	1. informal demo's, lunch and learns and team showcases, build support for the idea
4. seek the sign off you need
	1. gather evidence from previous steps


# Personal
improve on: Ask questions, actively listening, positive, make a plan, do not act directly, be patient, know what cheese somebody likes, 
use it wisely
